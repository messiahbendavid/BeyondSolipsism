...
class Config:
    symbols: List[str] = field(default_factory=lambda: [
        ...
        # Semiconductors
        'TXN', 'NXPI', 'MPWR', 'ON', 'SWKS', 'QRVO', 'MCHP', 'STM', 'GFS', 'ASX',
        'WOLF', 'CRUS', 'SLAB', 'DIOD', 'SMTC', 'ALGM', 'ACLS', 'FORM', 'UCTT', 'COHU',
        'RMBS', 'SYNA', 'SITM', 'POWI', 'AMBA', 'LSCC', 'MTSI', 'ONTO', 'AOSL', 'SGH',
        # Software
        'MSFT', 'ADBE', 'CRM', 'NOW', 'INTU', 'WDAY', 'TEAM', 'HUBS', 'DDOG', 'SNOW',
        'MDB', 'NET', 'ZS', 'CRWD', 'PANW', 'FTNT', 'OKTA', 'ZM', 'DOCU', 'SPLK',
        'ANSS', 'PTC', 'MANH', 'GWRE', 'PCTY', 'PAYC', 'BILL', 'APPF', 'BSY', 'TOST',
        'BRZE', 'CFLT', 'ESTC', 'GTLB', 'SMAR', 'DOCN', 'PD', 'FROG', 'NEWR', 'SPT',
        'ALTR', 'RBRK', 'IOT', 'AI', 'PATH', 'ASAN', 'MNDY', 'APPN', 'PEGA', 'TENB',
        'QUALYS', 'RPD', 'CYBR', 'SAIL', 'VRNS', 'JAMF', 'EVBG', 'SUMO', 'FSLY', 'BAND',
        'API', 'TWLO', 'COUP', 'VEEV', 'CDAY', 'ADP', 'PAYX', 'CSGP', 'TYL', 'CCCS',
        'SSNC', 'FDS', 'MSCI', 'MORN', 'CBOE', 'NDAQ', 'VRSN', 'AKAM', 'FFIV', 'JNPR',
        'NTAP', 'HPE', 'HPQ', 'DELL', 'PSTG', 'ZI', 'PRGS', 'OTEX', 'LDOS', 'SAIC',
        'BAH', 'CACI', 'KTOS', 'MRCY', 'PSN', 'MANT', 'KBR', 'BWXT', 'VVX', 'GRMN',
        # IT Services & Consulting
        'ACN', 'CTSH', 'INFY', 'WIT', 'EPAM', 'GLOB', 'EXLS', 'TASK', 'TTEC', 'PRFT',
        'DXC', 'GIB', 'CLVT', 'BR', 'FIS', 'FISV', 'GPN', 'FLT', 'WEX', 'JKHY',
        # Hardware & Equipment
        'APH', 'TEL', 'GLW', 'KEYS', 'ZBRA', 'CDW', 'SNX', 'ARW', 'AVT', 'NSIT',
        'SCSC', 'CNXC', 'SMCI', 'ANET', 'CIEN', 'LITE', 'VIAV', 'INFN', 'COMM', 'CALX',
        'AAOI', 'COHR', 'IIVI', 'MKSI', 'NOVT', 'IPGP', 'CGNX', 'TER', 'BRKS', 'ENTG',
        # Internet & E-commerce
        'BABA', 'JD', 'PDD', 'BIDU', 'NTES', 'TCOM', 'VIPS', 'BZUN', 'ATHM', 'BILI',
        'IQ', 'TME', 'YMM', 'QFIN', 'FINV', 'LX', 'TIGR', 'FUTU', 'RBLX', 'U',
        'TTWO', 'EA', 'ATVI', 'ZNGA', 'DKNG', 'RSI', 'PENN', 'GENI', 'SKLZ', 'MTCH',
        'BMBL', 'IAC', 'ANGI', 'TREE', 'QUOT', 'YELP', 'TRIP', 'EXPE', 'BKNG', 'ABNB',
        'TRVG', 'PRCH', 'OPEN', 'RDFN', 'Z', 'ZG', 'REAL', 'COMP', 'FIGS', 'RENT',
        'CHWY', 'W', 'ETSY', 'EBAY', 'WISH', 'POSH', 'MNST', 'CARG', 'VRM', 'CVNA',
        
        # ==================== FINANCIALS (150+) ====================
        # Major Banks
        'JPM', 'BAC', 'WFC', 'C', 'GS', 'MS', 'USB', 'PNC', 'TFC', 'SCHW',
        'BK', 'STT', 'NTRS', 'FITB', 'MTB', 'CFG', 'RF', 'HBAN', 'KEY', 'ZION',
        'CMA', 'FHN', 'FCNCA', 'SIVB', 'SBNY', 'FRC', 'WAL', 'PACW', 'EWBC', 'WBS',
        'CBSH', 'PNFP', 'BOKF', 'SNV', 'HWC', 'FNB', 'ASB', 'UBSI', 'VLY', 'TCBI',
        'UMBF', 'FFIN', 'SFNC', 'ONB', 'ABCB', 'IBOC', 'OZK', 'CADE', 'WTFC', 'GBCI',
        'BKU', 'INDB', 'COLB', 'FIBK', 'TOWN', 'BANF', 'TRMK', 'WSFS', 'HOMB', 'HOPE',
        'FULT', 'NBTB', 'CVBF', 'SBCF', 'WABC', 'BUSE', 'BANR', 'PPBI', 'EFSC', 'TBBK',
        # Credit Cards & Consumer Finance
        'V', 'MA', 'AXP', 'DFS', 'COF', 'SYF', 'ALLY', 'OMF', 'SLM', 'NAVI',
        'SOFI', 'AFRM', 'UPST', 'LC', 'HOOD', 'COIN', 'LPLA', 'RJF', 'SF', 'EVR',
        'LAZ', 'HLI', 'PJT', 'MC', 'JEF', 'MKTX', 'VIRT', 'IBKR', 'BGCP', 'SNEX',
        # Insurance
        'BRK.B', 'CB', 'PGR', 'ALL', 'MET', 'PRU', 'AIG', 'AFL', 'TRV', 'HIG',
        'MMC', 'AON', 'MARSH', 'WTW', 'AJG', 'BRO', 'ERIE', 'RLI', 'KNSL', 'PLMR',
        'RYAN', 'GSHD', 'WLTW', 'CINF', 'L', 'LNC', 'UNUM', 'PFG', 'VOYA', 'CNO',
        'FAF', 'FNF', 'STC', 'AFG', 'WRB', 'RE', 'RNR', 'ACGL', 'ARCH', 'ESGR',
        'AXS', 'ORI', 'KMPR', 'HMN', 'THG', 'SIGI', 'JRVR', 'PROS', 'AMSF', 'HALL',
        # Asset Management
        'BLK', 'SPGI', 'MCO', 'CME', 'ICE', 'NDAQ', 'CBOE', 'TROW', 'IVZ', 'BEN',
        'AMG', 'EV', 'JHG', 'VCTR', 'APAM', 'CNS', 'HLNE', 'STEP', 'VRTS', 'WDR',
        'GBL', 'OWL', 'BX', 'KKR', 'APO', 'CG', 'ARES', 'BAM', 'TPG', 'HTGC',
        'MAIN', 'ARCC', 'FSK', 'BXSL', 'GBDC', 'GSBD', 'OCSL', 'TSLX', 'CGBD', 'FDUS',
        # REITs (See separate section below)
        
        # ==================== HEALTHCARE (150+) ====================
        # Pharmaceuticals
        'JNJ', 'PFE', 'ABBV', 'MRK', 'LLY', 'BMY', 'AMGN', 'GILD', 'BIIB', 'REGN',
        'VRTX', 'MRNA', 'BNTX', 'NVAX', 'ZTS', 'VTRS', 'TAK', 'SNY', 'GSK', 'AZN',
        'NVO', 'NVS', 'TEVA', 'MYL', 'ENDP', 'PRGO', 'JAZZ', 'ALKS', 'NBIX', 'PTCT',
        'FOLD', 'RARE', 'BLUE', 'SGEN', 'EXEL', 'INCY', 'ALNY', 'BMRN', 'SRPT', 'BPMC',
        'IMVT', 'KRYS', 'PCVX', 'DAWN', 'RXRX', 'RLAY', 'KYMR', 'TGTX', 'ALLK', 'RVNC',
        # Biotech
        'GILD', 'AMGN', 'BIIB', 'VRTX', 'REGN', 'MRNA', 'BNTX', 'SGEN', 'ALNY', 'BMRN',
        'EXEL', 'INCY', 'IONS', 'SRPT', 'HZNP', 'UTHR', 'TECH', 'BIO', 'NTRA', 'ILMN',
        'QGEN', 'HOLX', 'GH', 'NVTA', 'PACB', 'TXG', 'TWST', 'CDNA', 'CERS', 'BRKR',
        'EXAS', 'OLINK', 'ME', 'DNA', 'BEAM', 'EDIT', 'CRSP', 'NTLA', 'VERV', 'PRME',
        # Medical Devices
        'ABT', 'MDT', 'DHR', 'TMO', 'SYK', 'BSX', 'EW', 'ISRG', 'BDX', 'ZBH',
        'ALGN', 'IDXX', 'RMD', 'TFX', 'HOLX', 'DXCM', 'PODD', 'TNDM', 'IRTC', 'LIVN',
        'NVST', 'XRAY', 'MASI', 'NUVA', 'GMED', 'ATRC', 'SWAV', 'SHAK', 'INSP', 'AXNX',
        'RGEN', 'RVTY', 'AZTA', 'CRL', 'MEDP', 'ICLR', 'SYNH', 'CTLT', 'WST', 'AVTR',
        'STVN', 'BRKR', 'NEOG', 'OFIX', 'LNTH', 'PRCT', 'NARI', 'SILK', 'APEN', 'AORT',
        # Health Insurers & Services
        'UNH', 'ELV', 'CVS', 'CI', 'HUM', 'CNC', 'MOH', 'HCA', 'THC', 'UHS',
        'ACHC', 'SGRY', 'EHC', 'ADUS', 'AMED', 'ENSG', 'NHC', 'PNTG', 'USPH', 'CCRN',
        'AMN', 'HCSG', 'CHE', 'BKD', 'OGN', 'NHI', 'LTC', 'SBRA', 'OHI', 'WELL',
        'VTR', 'PEAK', 'DOC', 'HR', 'CTRE', 'MPW', 'GMRE', 'DHC', 'SNH', 'CHCT',
        # Pharma Distribution
        'MCK', 'ABC', 'CAH', 'HSIC', 'PDCO', 'OMI', 'PBH', 'ELAN', 'MMS', 'PINC',
        
        # ==================== CONSUMER DISCRETIONARY (120+) ====================
        # Retail
        'AMZN', 'HD', 'LOW', 'TJX', 'ROST', 'BURL', 'GPS', 'ANF', 'AEO', 'URBN',
        'EXPR', 'LULU', 'NKE', 'UAA', 'CROX', 'SKX', 'DECK', 'SHOO', 'WWW', 'ONON',
        'FL', 'HIBB', 'ASO', 'DKS', 'BGFV', 'BWMX', 'CAL', 'GES', 'PVH', 'RL',
        'TPR', 'CPRI', 'VFC', 'HBI', 'GIII', 'CRI', 'COLM', 'OXM', 'SCVL', 'BOOT',
        'WMT', 'TGT', 'COST', 'BJ', 'PSMT', 'DG', 'DLTR', 'FIVE', 'OLLI', 'BBY',
        'WSM', 'RH', 'ARHS', 'LOVE', 'ETD', 'BNED', 'LL', 'FND', 'TILE', 'SCS',
        'CVNA', 'KMX', 'SAH', 'AN', 'PAG', 'ABG', 'LAD', 'RUSHA', 'GPI', 'VRM',
        'ORLY', 'AZO', 'AAP', 'GPC', 'LKQ', 'MNRO', 'PRTS', 'MOD', 'MPAA', 'SMP',
        # Restaurants
        'MCD', 'SBUX', 'YUM', 'CMG', 'DPZ', 'QSR', 'DRI', 'BLMN', 'TXRH', 'BJRI',
        'RUTH', 'DENN', 'EAT', 'DIN', 'CAKE', 'JACK', 'SHAK', 'WING', 'PTLO', 'BROS',
        'LOCO', 'PZZA', 'FRGI', 'ARCO', 'FAT', 'BBW', 'NDLS', 'KRUS', 'TACO', 'RRGB',
        # Hotels, Travel & Leisure
        'MAR', 'HLT', 'WH', 'H', 'CHH', 'IHG', 'ABNB', 'BKNG', 'EXPE', 'TRIP',
        'MMYT', 'TRVG', 'RCL', 'CCL', 'NCLH', 'LVS', 'MGM', 'WYNN', 'CZR', 'BYD',
        'PENN', 'DKNG', 'GENI', 'BALY', 'RSI', 'RRR', 'MCRI', 'HGV', 'VAC', 'TNL',
        'PLYA', 'MTN', 'SKI', 'EPR', 'FUN', 'SIX', 'SEAS', 'FLY', 'BLDE', 'JOBY',
        # Autos
        'TSLA', 'F', 'GM', 'RIVN', 'LCID', 'FSR', 'NIO', 'XPEV', 'LI', 'PSNY',
        'STLA', 'HMC', 'TM', 'VWAGY', 'RACE', 'APTV', 'BWA', 'ALV', 'LEA', 'VC',
        'ADNT', 'AXL', 'DAN', 'LCII', 'MOD', 'SRI', 'THRM', 'DORM', 'MTOR', 'CWH',
        'WGO', 'THO', 'PATK', 'LCI', 'BC', 'FOX', 'HOG', 'PII', 'NWTN', 'GOEV',
        # Media & Entertainment
        'DIS', 'NFLX', 'WBD', 'PARA', 'LGF.A', 'AMC', 'CNK', 'IMAX', 'MSGS', 'LYV',
        'SPOT', 'SIRI', 'IHRT', 'CMCSA', 'CHTR', 'CABO', 'DISH', 'ATUS', 'FYBR', 'LUMN',
        'TTWO', 'EA', 'ATVI', 'RBLX', 'U', 'ZNGA', 'PLTK', 'GLBE', 'APPS', 'DDI',
        
        # ==================== CONSUMER STAPLES (70+) ====================
        # Food & Beverage
        'PEP', 'KO', 'MNST', 'KDP', 'STZ', 'BF.B', 'DEO', 'SAM', 'FIZZ', 'COKE',
        'CELH', 'ZVIA', 'TAP', 'BUD', 'ABEV', 'CCU', 'WVVI', 'PRMW', 'FARM', 'LW',
        'GIS', 'K', 'CPB', 'SJM', 'CAG', 'HRL', 'TSN', 'SAFM', 'PPC', 'BRFS',
        'MDLZ', 'HSY', 'TR', 'RMCF', 'LNDC', 'THS', 'CENTA', 'BGS', 'FLO', 'LANC',
        'MKC', 'SEB', 'JJSF', 'CHEF', 'LMNR', 'FRPT', 'SMPL', 'HAIN', 'BRBR', 'BYND',
        'DAR', 'INGR', 'MGPI', 'OTLY', 'TATF', 'STKL', 'NOMD', 'FREE', 'VITL', 'COCO',
        # Household Products
        'PG', 'CL', 'KMB', 'CHD', 'CLX', 'SPB', 'SWM', 'ENR', 'IPAR', 'HELE',
        'COTY', 'ELF', 'EL', 'SKIN', 'USNA', 'HIMS', 'NU', 'PRCH', 'WRBY', 'XPOF',
        # Retail - Grocery & Drug
        'WMT', 'COST', 'KR', 'WBA', 'SYY', 'USFD', 'PFGC', 'CHEF', 'SPTN', 'ACI',
        'GO', 'IMKTA', 'WMK', 'NGVC', 'SFM', 'KR', 'ACI', 'VLGEA', 'UNFI', 'BJ',
        # Tobacco
        'PM', 'MO', 'BTI', 'UVV', 'VGR', 'TPB', 'XXII', 'CRON', 'TLRY', 'CGC',
        
        # ==================== INDUSTRIALS (140+) ====================
        # Aerospace & Defense
        'BA', 'LMT', 'RTX', 'NOC', 'GD', 'LHX', 'TDG', 'HWM', 'HEI', 'AXON',
        'TXT', 'HII', 'LDOS', 'SAIC', 'BAH', 'CACI', 'KTOS', 'MRCY', 'PSN', 'MANT',
        'KBR', 'BWXT', 'AIR', 'SPR', 'TGI', 'ERJ', 'AJRD', 'AVAV', 'RKLB', 'SPCE',
        'ATRO', 'CW', 'MOG.A', 'GE', 'WWD', 'ESLT', 'DCO', 'NPK', 'VSEC', 'ASTR',
        # Machinery & Equipment
        'CAT', 'DE', 'PCAR', 'CMI', 'AGCO', 'CNHI', 'TITN', 'OSK', 'TTC', 'MTW',
        'GATO', 'ASTE', 'HAYN', 'SHYF', 'ALTG', 'REVG', 'WABCO', 'NAV', 'ALSN', 'HLIO',
        'IR', 'ITW', 'ETN', 'PH', 'ROK', 'AME', 'ROP', 'NDSN', 'DOV', 'IEX',
        'IDEX', 'XYL', 'GGG', 'LECO', 'FELE', 'MIDD', 'AOS', 'WTS', 'TT', 'CARR',
        'LII', 'JCI', 'GNRC', 'GTES', 'SPXC', 'FLS', 'ATKR', 'GTLS', 'BMI', 'FBIN',
        # Transportation
        'UNP', 'CSX', 'NSC', 'CP', 'CNI', 'KSU', 'GWR', 'RAIL', 'TRN', 'GBX',
        'WAB', 'FSTR', 'ARCB', 'CHRW', 'EXPD', 'HUBG', 'XPO', 'GXO', 'JBHT', 'WERN',
        'LSTR', 'SNDR', 'KNX', 'HTLD', 'ODFL', 'SAIA', 'R', 'RXO', 'PNCK', 'ECHO',
        'ATSG', 'AIRT', 'MATX', 'KEX', 'TRTN', 'GATX', 'FDX', 'UPS', 'ZTO', 'UHAL',
        'DAL', 'UAL', 'AAL', 'LUV', 'ALK', 'JBLU', 'SAVE', 'HA', 'MESA', 'SKYW',
        'ALGT', 'SNCY', 'ULCC', 'JOBY', 'BLDE', 'ACHR', 'LILM', 'BA', 'RYCEY', 'SAF',
        # Building Products & Construction
        'SHW', 'PPG', 'AXTA', 'RPM', 'AZEK', 'TREX', 'MAS', 'JELD', 'MHK', 'FBHS',
        'BLDR', 'BLD', 'BECN', 'GMS', 'FBM', 'UFPI', 'DOOR', 'PGTI', 'AWI', 'TILE',
        'APOG', 'SUM', 'MLM', 'VMC', 'EXP', 'CX', 'USLM', 'SMID', 'FLR', 'J',
        'PWR', 'EME', 'FIX', 'MTZ', 'DY', 'STRL', 'PRIM', 'MYRG', 'ROAD', 'GLDD',
        # Electrical Equipment
        'EMR', 'HON', 'MMM', 'ABB', 'ROK', 'AME', 'ROP', 'ETN', 'PH', 'AYI',
        'HUBB', 'LIT', 'ACVA', 'BE', 'PLUG', 'BLDP', 'FCEL', 'GNRC', 'ENPH', 'SEDG',
        # Industrial Conglomerates & Services
        'GE', 'MMM', 'HON', 'ROP', 'ITW', 'EMR', 'CMI', 'DOV', 'SWK', 'PNR',
        'ALLE', 'MAS', 'AOS', 'LII', 'POOL', 'SITE', 'EXP', 'CIN', 'WMS', 'FERG',
        'WSO', 'FAST', 'GWW', 'MSM', 'CNM', 'DNOW', 'NOW', 'DCI', 'HDS', 'LAWS',
        'WCC', 'WESCO', 'ESCO', 'AIMC', 'SSD', 'RBC', 'GGG', 'LECO', 'KMT', 'NDSN',
        # Professional Services
        'ACN', 'IBM', 'CTSH', 'IT', 'EPAM', 'GLOB', 'EXLS', 'WU', 'PAYX', 'ADP',
        'TRI', 'INFO', 'NLSN', 'CSGP', 'BAH', 'LHX', 'WSO', 'ROL', 'CTAS', 'ARMK',
        'ABM', 'BRC', 'CLH', 'ECOL', 'US', 'GFL', 'WM', 'RSG', 'WCN', 'MEG',
        
        # ==================== ENERGY (80+) ====================
        # Major Oil & Gas
        'XOM', 'CVX', 'COP', 'EOG', 'SLB', 'MPC', 'PSX', 'VLO', 'OXY', 'HES',
        'PXD', 'DVN', 'HAL', 'BKR', 'FANG', 'MRO', 'APA', 'CTRA', 'EQT', 'OVV',
        'CLR', 'MTDR', 'CHRD', 'PR', 'PDCE', 'GPOR', 'RRC', 'AR', 'SWN', 'CNX',
        'MGY', 'SM', 'TALO', 'CRGY', 'TELL', 'CPE', 'ROCC', 'ESTE', 'VTOL', 'REI',
        # Oil Services & Equipment
        'SLB', 'HAL', 'BKR', 'NOV', 'FTI', 'TS', 'WFRD', 'RES', 'HP', 'PTEN',
        'OII', 'HLX', 'LBRT', 'NR', 'OIS', 'TDW', 'DRQ', 'WTTR', 'WHD', 'AROC',
        'CLB', 'TTI', 'XPRO', 'PUMP', 'ACDC', 'USAC', 'BOOM', 'SOC', 'SND', 'CRK',
        # Refining & Marketing
        'MPC', 'PSX', 'VLO', 'DK', 'DINO', 'PBF', 'HFC', 'CVI', 'CLMT', 'PARR',
        # Midstream
        'KMI', 'WMB', 'OKE', 'EPD', 'ET', 'MPLX', 'ENB', 'TRP', 'PAA', 'PSXP',
        'WES', 'TRGP', 'AM', 'CEQP', 'DTM', 'HESM', 'ENLC', 'SMLP', 'NS', 'DKL',
        # Clean Energy
        'NEE', 'ENPH', 'SEDG', 'FSLR', 'RUN', 'SPWR', 'NOVA', 'ARRY', 'CSIQ', 'JKS',
        'DQ', 'MAXN', 'SHLS', 'BLDP', 'PLUG', 'BE', 'FCEL', 'CHPT', 'EVGO', 'BLNK',
        'CLNE', 'LNG', 'GLNG', 'FLNG', 'GMLP', 'KNOP', 'CPLP', 'DLNG', 'NFE', 'TEL',
        
        # ==================== MATERIALS (60+) ====================
        # Chemicals
        'LIN', 'APD', 'SHW', 'ECL', 'DD', 'DOW', 'LYB', 'PPG', 'NUE', 'STLD',
        'EMN', 'ALB', 'FMC', 'CF', 'MOS', 'NTR', 'CE', 'CTVA', 'IFF', 'AVNT',
        'ASH', 'HUN', 'OLN', 'WLK', 'TROX', 'KRO', 'IOSP', 'CC', 'AXTA', 'RPM',
        'CBT', 'KWR', 'ASIX', 'HWKN', 'MTX', 'NGVT', 'OEC', 'KOP', 'LTHM', 'MEOH',
        # Metals & Mining
        'FCX', 'NEM', 'GOLD', 'AEM', 'KGC', 'AU', 'AGI', 'HL', 'PAAS', 'CDE',
        'MAG', 'EXK', 'FSM', 'GATO', 'NG', 'SBSW', 'USAU', 'NUE', 'STLD', 'RS',
        'CMC', 'CLF', 'X', 'MT', 'AA', 'CENX', 'KALU', 'ZEUS', 'ATI', 'HAYN',
        'ARNC', 'TMST', 'USAP', 'CRS', 'MTRN', 'WOR', 'SXC', 'HCC', 'ARCH', 'BTU',
        # Paper & Packaging
        'PKG', 'IP', 'WRK', 'SEE', 'SON', 'BLL', 'CCK', 'GPK', 'GEF', 'ATR',
        'SLGN', 'OI', 'PTVE', 'AMBP', 'ARD', 'CLW', 'MERC', 'NP', 'PACK', 'REXR',
        
        # ==================== UTILITIES (50+) ====================
        # Electric Utilities
        'NEE', 'DUK', 'SO', 'D', 'AEP', 'SRE', 'EXC', 'XEL', 'WEC', 'ED',
        'PEG', 'ES', 'AWK', 'AEE', 'DTE', 'FE', 'PPL', 'EIX', 'ETR', 'CNP',
        'CMS', 'EVRG', 'AES', 'NI', 'PNW', 'OGE', 'POR', 'NWE', 'AVA', 'BKH',
        'MGEE', 'NWN', 'UTL', 'SJW', 'CWT', 'MSEX', 'ARTNA', 'YORW', 'CDZI', 'GWRS',
        # Gas Utilities
        'LNT', 'NJR', 'ATO', 'NFG', 'OGS', 'SR', 'SWX', 'RGCO', 'SPH', 'CPK',
        # Multi-Utilities
        'DUK', 'D', 'NGG', 'NI', 'CMS', 'WEC', 'ED', 'PEG', 'ES', 'AEE',
        
        # ==================== REAL ESTATE (80+) ====================
        # REITs - Industrial
        'PLD', 'DRE', 'REXR', 'FR', 'EGP', 'STAG', 'TRNO', 'IIPR', 'GTY', 'LAND',
        # REITs - Residential
        'EQR', 'AVB', 'ESS', 'MAA', 'UDR', 'CPT', 'AIRC', 'NXRT', 'ELME', 'IRT',
        'INVH', 'AMH', 'SUI', 'ELS', 'UMH', 'NNN', 'APLE', 'SVC', 'CLDT', 'HT',
        # REITs - Office
        'BXP', 'VNO', 'SLG', 'KRC', 'DEI', 'HIW', 'CUZ', 'HPP', 'OFC', 'PDM',
        'CLI', 'BDN', 'PGRE', 'FSP', 'ESRT', 'NYC', 'ALEX', 'WRE', 'OPI', 'GNL',
        # REITs - Retail
        'SPG', 'O', 'REG', 'FRT', 'KIM', 'BRX', 'ROIC', 'UE', 'SITC', 'AKR',
        'RPT', 'JBGS', 'CBL', 'PEI', 'MAC', 'SKT', 'STOR', 'SRC', 'FCPT', 'EPRT',
        # REITs - Healthcare
        'WELL', 'VTR', 'PEAK', 'OHI', 'HR', 'DOC', 'SBRA', 'CTRE', 'NHI', 'LTC',
        'MPW', 'GMRE', 'DHC', 'SNH', 'CHCT', 'ENSG', 'NHC', 'CSR', 'UHT', 'PLYM',
        # REITs - Data Centers & Towers
        'AMT', 'CCI', 'EQIX', 'DLR', 'SBAC', 'UNIT', 'CONE', 'QTS', 'COR', 'LMRK',
        # REITs - Storage
        'PSA', 'EXR', 'CUBE', 'LSI', 'NSA', 'REXR', 'JCAP', 'SELF', 'DRMA', 'GCMG',
        # REITs - Specialty
        'WY', 'LADR', 'ARI', 'BXMT', 'STWD', 'ABR', 'GPMT', 'ACRE', 'KREF', 'RC',
        'NLY', 'AGNC', 'ARR', 'ORC', 'TWO', 'MFA', 'PMT', 'RITM', 'NYMT', 'CIM',
        
        # ==================== COMMUNICATION SERVICES (50+) ====================
        # Telecom
        'T', 'VZ', 'TMUS', 'CHTR', 'CMCSA', 'LBRDA', 'LBRDK', 'FYBR', 'LUMEN', 'FTR',
        'USM', 'TDS', 'SHEN', 'CCOI', 'GOGO', 'BAND', 'ATEN', 'OOMA', 'RBBN', 'VG',
        'CALX', 'ADTN', 'CLFD', 'INFN', 'VIAV', 'LITE', 'AAOI', 'COHR', 'IIVI', 'CIEN',
        # Media
        'GOOGL', 'META', 'NFLX', 'DIS', 'WBD', 'PARA', 'FOXA', 'FOX', 'NWSA', 'NWS',
        'NYT', 'GCI', 'TGNA', 'SSP', 'GTN', 'EVC', 'SBGI', 'NXST', 'TNL', 'MGNI',
        'TTD', 'PUBM', 'CRTO', 'DV', 'IAS', 'ZD', 'RAMP', 'QNST', 'SCOR', 'OMCL',
        'IPG', 'OMC', 'WPP', 'STGW', 'MGID', 'NCMI', 'MSGS', 'EDR', 'LYV', 'SPOT',
        
        # ==================== ADDITIONAL HIGH GROWTH & SPACS (50+) ====================
        'RKLB', 'ASTR', 'SPCE', 'ASTS', 'BKSY', 'IRDM', 'VSAT', 'GSAT', 'GILT',
        'MP', 'LAC', 'LTHM', 'PLL', 'ALB', 'SQM', 'ALTM', 'UUUU', 'CCJ', 'DNN',
        'LEU', 'NXE', 'URG', 'UEC', 'LTBR', 'SMR', 'OKLO', 'NNE', 'BWXT', 'FLR',
        'IONQ', 'QBTS', 'RGTI', 'QUBT', 'ARQQ', 'SOUN', 'BBAI', 'AI', 'PRCT',
        'SDGR', 'EXAI', 'MTTR', 'VIEW', 'DNA', 'DNAY', 'RXRX', 'RLAY', 'ABCL',
        'GRPH', 'SMRT', 'RELY', 'KORE', 'INOD', 'MDAI', 'KLTR', 'ONDS', 'ORGN',
        
        # ==================== INTERNATIONAL ADRs (50+) ====================
        # China
        'BABA', 'JD', 'PDD', 'BIDU', 'NTES', 'TCOM', 'NIO', 'XPEV', 'LI', 'BILI',
        'IQ', 'TME', 'YMM', 'QFIN', 'FINV', 'LX', 'TIGR', 'FUTU', 'VIPS', 'BZUN',
        # Europe
        'ASML', 'NVO', 'SAP', 'TM', 'SONY', 'SNY', 'GSK', 'AZN', 'NVS', 'DEO',
        'UL', 'BP', 'SHEL', 'TTE', 'EQNR', 'RIO', 'BHP', 'VALE', 'GOLD', 'ABB',
        # Japan & Korea
        'TM', 'HMC', 'SONY', 'MUFG', 'SMFG', 'KB', 'SHG', 'WF', 'LPL', 'ENIC',
        # Latin America
        'NU', 'STNE', 'PAGS', 'XP', 'MELI', 'GLOB', 'DESP', 'ARCO', 'BRFS', 'JBS',
        # Canada
        'TD', 'RY', 'BMO', 'BNS', 'CM', 'ENB', 'TRP', 'CNQ', 'SU', 'CP',
        'CNI', 'NTR', 'SHOP', 'LSPD', 'OTEX', 'BB', 'CGC', 'TLRY', 'WEED', 'ACB',
    ])
